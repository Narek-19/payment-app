...
export default function Page() {
  const [startCheckout,setStartCheckout] = useState(false);
    ...
    return (
      <>
        <PaymentProcess setStartCheckout={setStartCheckout} price={4700} titlePlan="Profesional" startCheckout={startCheckout}/>
          ...
          <div className="p-8">
            <div className="flex items-center justify-center">
              <div className="text-center">
                <span className="text-5xl font-bold text-[#0e537e]">$4,700</span>
            ...
            <div className="mt-10 space-y-8">
              <div>
                ...
                <div className="space-y-4">
                  <Feature>Enterprise Website Creation</Feature>
                  <Feature>Mobile Responsive Design</Feature>
                  <Feature>Best SEO Optimization</Feature>
                  <Feature>Contact Form Integration</Feature>
                  <Feature>Professional Support Package</Feature>
                </div>
              </div>
            ...
            <div className="mt-8 text-center text-sm text-gray-500">
              Need more features? Check out our Enterprise and Enterprise plans
            </div>
          </div>
        </div>
