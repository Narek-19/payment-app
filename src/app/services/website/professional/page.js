...
export default  function Page() {
  const [startCheckout,setStartCheckout] = useState(false);
    ...
    return (
      <>
         <PaymentProcess setStartCheckout={setStartCheckout} price={3370} titlePlan="Basic" startCheckout={startCheckout}/>
          ...
          <div className="p-8">
            <div className="flex items-center justify-center">
              <div className="text-center">
                <span className="text-5xl font-bold text-[#0e537e]">$3,370</span>
