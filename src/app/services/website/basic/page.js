...
const [startCheckout,setStartCheckout] = useState(false);
    ...
    return (
      <>
      {startCheckout && <PaymentProcess setStartCheckout={setStartCheckout} price={1350} titlePlan="Basic" startCheckout={startCheckout}/>}
            ...
            <div className="mt-10 space-y-8">
              <div>
                ...
                <div className="space-y-4">
                  ...
                  <Feature>Standard Support Package</Feature>
                </div>
              </div>
